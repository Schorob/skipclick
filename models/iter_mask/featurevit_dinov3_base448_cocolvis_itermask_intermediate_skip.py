...
MODEL_NAME = 'cocolvis_featurevit_dinov3_base448_intermediate_plus4_skip'
...
def init_model(cfg):
    ...
    model = FeatureVitModel(
        use_disks=True,
        norm_radius=5,
        with_prev_mask=True,
        extractor_type = 'dinov3_vitb16',
        backbone_params=backbone_params,
        backbone_repo_path=cfg.DINOV3_PATHS.REPO,
        backbone_weight_path=cfg.DINOV3_PATHS.VIT_B_WEIGHTS,
        neck_params=neck_params,
        head_params=head_params,
        random_split=cfg.random_split,
        trained_extractor=False,
        use_intermediate = [2, 5, 8, 11],
...
def train(model, cfg, model_cfg):
    ...
    train_augmentator = Compose([
        ...
        HorizontalFlip(),
        PadIfNeeded(min_height=crop_size[0], min_width=crop_size[1], border_mode=0, value=0.0),
