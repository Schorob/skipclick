...
def example_data():
    data = [
                ...
                #     [0 for _ in range(9)]]),
                ('NoC@85%', [
                    [1.36, 1.40, 3.79, 1.94, 3.47, 2.05],
                    [0 for _ in range(6)],
                    [1.70, 1.83, 4.41, 2.71, 4.46, 2.90],
                    [0 for _ in range(6)],
                    [0 for _ in range(6)]]),
                ('NoC@90%', [
                    [1.50, 2.08, 5.11, 2.25, 5.54, 2.79],
                    [0 for _ in range(6)],
                    [1.92, 2.79, 6.08, 3.17, 6.79, 3.80],
                    [0 for _ in range(6)],
                    [0 for _ in range(6)]])
    ]
    return data
...
if __name__ == '__main__':
    ...
    datasets = ['GrabCut', 'Berkeley', 'DAVIS', 'Pascal', 'SBD', 'COCO_MVal']
