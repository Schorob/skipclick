...
def get_dataset(dataset_name, cfg):
    ...
    ######################### WSESeg Classes ##################################
        ...
        dataset = WSESeg(cfg.WSESEG_PATH, class_name="flickr_bobsleighs")
    elif dataset_name == "WSESeg_flickr_curling_stone":
        dataset = WSESeg(cfg.WSESEG_PATH, class_name="flickr_curling_stone")
    elif dataset_name == "WSESeg_flickr_ski_helmets":
        dataset = WSESeg(cfg.WSESEG_PATH, class_name="flickr_ski_helmets")
    elif dataset_name == "WSESeg_flickr_snow_kites":
        dataset = WSESeg(cfg.WSESEG_PATH, class_name="flickr_snow_kites")
    elif dataset_name == "WSESeg_yt_sports":
        dataset = WSESeg(cfg.WSESEG_PATH, class_name="yt_sports")
    elif dataset_name == "WSESeg_flickr_curling_brooms":
        dataset = WSESeg(cfg.WSESEG_PATH, class_name="flickr_curling_brooms")
    elif dataset_name == "WSESeg_flickr_ski_goggles":
        dataset = WSESeg(cfg.WSESEG_PATH, class_name="flickr_ski_goggles")
    elif dataset_name == "WSESeg_flickr_ski_misc":
        dataset = WSESeg(cfg.WSESEG_PATH, class_name="flickr_ski_misc")
    elif dataset_name == "WSESeg_flickr_slalom_obstacles":
        dataset = WSESeg(cfg.WSESEG_PATH, class_name="flickr_slalom_obstacles")
    elif dataset_name == "WSESeg_flickr_snowboards":
        dataset = WSESeg(cfg.WSESEG_PATH, class_name="flickr_snowboards")
    ############################################################################
    elif dataset_name == "SHSeg":
        dataset = SHSeg(cfg.SHSEG_PATH)
    else:
        dataset = None
...
def get_results_table(noc_list, over_max_list, brs_type, dataset_name, mean_spc, elapsed_time,
    ...
    table_header = (f'|{"BRS Type":^13}|{"Dataset":^30}|'
    ...
    table_row = f'|{brs_type:^13}|{dataset_name:^30}|'
