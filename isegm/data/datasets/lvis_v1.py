...
class Lvis_v1_Dataset(ISDataset):
    def __init__(self, dataset_path, subsample=False, split='train',
        ...
        if subsample and len(self.dataset_samples) > 9642:
            random.seed(1234567890)
            self.dataset_samples = random.sample(self.dataset_samples, 9642)
