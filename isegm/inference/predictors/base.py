...
class BasePredictor(object):
    ...
    def get_prediction(self, clicker, prev_mask=None):
        ...
        # We assume this to work, since the channel dimension (dim=1) is not touched by any
        # of the transforms. Also, all of the transforms seem to be geometric in nature.
